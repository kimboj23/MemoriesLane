...
Both are fixed, but this is a trade-off that keeps having a real, user-facing cost, not a purely theoretical one anymore — worth weighing that against the migration effort next time it comes up.
